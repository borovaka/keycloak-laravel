...
namespace Borovaka\KeycloakLaravel;
...
use Borovaka\KeycloakLaravel\Handler\AbstractProvider;
use Borovaka\KeycloakLaravel\Handler\KeycloakResourceOwner;
use Borovaka\KeycloakLaravel\Handler\Exception\EncryptionConfigurationException;
...
class KeycloakProvider extends AbstractProvider
{
     ...
     * @var array
     */
    protected $scopes = ['name', 'email', 'roles', 'profile', 'web-origins'];
    ...
    {
        return ['name', 'email', 'roles', 'profile', 'web-origins'];
    }
